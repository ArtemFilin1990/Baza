...
```
/
├── gost/           # Только подшипники по ГОСТ
├── iso/            # Только подшипники по ISO
├── analogs/        # Таблицы соответствия ГОСТ ↔ ISO
└── sources/        # Литература, каталоги, стандарты
```

### Правила размещения
- **gost/** — файлы с маркировкой по ГОСТ
- **iso/** — файлы с маркировкой по ISO
- **analogs/** — только таблицы эквивалентности с проверкой размеров
